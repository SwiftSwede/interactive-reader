...
- **Group exam is collaborative, not individual.** One writer per group, real-time sync to members, no grades; teacher reveals answers question by question in review mode. Level-differentiated Task 2 (intermediate: paragraph restructuring; pre-intermediate: sentence correction). See PRD slices 49a–49e.
